                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            ...
                            <form method="POST" action="{{ route('register') }}" class="my-5">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" autocomplete="name" autofocus placeholder="Nom">
                                        @error('name')
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6"> <input id="password-confirm" type="password" class="form-control" name="password_confirmation" autocomplete="new-password" placeholder="Confirmez votre mot de passe">
                                        <div class="clearfix"></div>
                                    </div>
                                </div>
                            ...
                            <hr>
                            <div class="text-center">
                                <a class="large" href="{{ route('login') }}">Avez vous déja un Compte ? Connectez vous!</a>
                            </div>
                        </div>
                            </div>
                        </div>
