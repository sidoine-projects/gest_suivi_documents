...
<head>
  ...
  <section class="login-block">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <form method="POST" action="admin/reset-password" class="md-float-material form-material">
                        @csrf
                        ...
                        <div class="auth-box card">
                            <div class="card-block" style="box-shadow: 0 8px 8px rgb(105 161 255);">
                                ...
                                <div class="row m-t-30">
                                    <div class="col-md-12">
                                        <button type="submit" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20" style="box-shadow: 0 4px 4px rgb(105 161 255);">Reset Password</button>
                                    </div>
                                </div>
                                <hr/>
                                <div class="row">
