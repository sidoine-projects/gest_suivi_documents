...
<div class="layout-content">
    ...
    <div class="container-fluid flex-grow-1 container-p-y">
        ...
        <div class="card mb-4">
            <h6 class="card-header"><i class="feather icon-user"></i> List Commune</h6>
            <div class="card-body">
                    ...
                    <tbody>
                        @foreach ($communes as $item)
                            <tr>
                                ...
                                <td class="id">
                                    {{ \App\Models\Departement::where(['id'=>$item->departement_id ])->first()->libelle}}
                                    {{-- {{ \App\Models\Departement::where(['id'=>$item->departement_id ])->pluck('libelle')->first()}} --}}

                                </td>             
                                <td class="id">{{ $item->libelle }}</td>                
                                <td class="text-center">
                                    <a href="{{ url('commune/update/'.$item->id) }}" class="m-r-15 text-muted userUpdate">
                                        <i class="fa fa-edit" style="color: #2196f3;"></i>
                                    </a>
                                    <a href="{{ url('commune/delete/'.$item->id) }}" onclick="return confirm('Are you sure to want to delete it?')"><i class="fa fa-trash" style="color: red;"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
