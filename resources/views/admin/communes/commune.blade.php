...
<div class="layout-content">
    ...
    <div class="container-fluid flex-grow-1 container-p-y">
        <h4 class="font-weight-bold py-3 mb-0">Commune / New</h4>
        ...
        <div class="card mb-4">
            <h6 class="card-header"><i class="feather icon-user"></i> Commune Infomation</h6>
            ...
            <div class="card-body">
                ...
                <form id="validation" action="{{ route('communes/save') }}" method="POST">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            ...
                            <select class="form-control" id="departement_id" name="departement_id"  required>
                                ...
                                <option value="" selected>selectionner departement...</option>
    ...
    <nav class="layout-footer footer bg-white">
        <div class="container-fluid d-flex flex-wrap justify-content-between text-center container-p-x pb-3">
            <div class="pt-3">
                <span class="footer-text font-weight-semibold">&copy; <a href="https://SoengSouy.com" class="footer-link" target="_blank">Starlabs</a></span>
            </div>
            <div>
