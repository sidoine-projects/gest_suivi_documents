...
<div class="layout-content">
    ...
    <div class="container-fluid flex-grow-1 container-p-y">
        <h4 class="font-weight-bold py-3 mb-0">Commune / Update</h4>
        <div class="text-muted small mt-0 mb-4 d-block breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{route('home')}}"><i class="feather icon-home"></i></a></li>
                <li class="breadcrumb-item">Commune Update</li>
                <li class="breadcrumb-item active">Commune Update</li>
            </ol>
        </div>

        <div class="card mb-4">
            <h6 class="card-header"><i class="feather icon-user"></i> Commune Update</h6>
            ...
            <div class="card-body">
                ...
                <form id="" action="{{ route('communes/edit') }}" method="POST">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            {{-- <input  class="form-control" id="code" name="code" placeholder="Enter un code" required> --}}

                            <select class="form-control" id="departement_id" name="departement_id"  required>

                                {{-- <option value="">selectionner departement...</option> --}}
                            
                                @foreach($data_dep as $data_dep)
                            
                                    <option @if ($datas->departement_id == $data_dep->id) selected @endif  value="{{ $data_dep->id }}">
                                        {{ $data_dep->libelle }} 
                                    </option>
                    ...
                    <div class="form-group row">
                        <label class="col-form-label col-sm-2 text-sm-right">Commune</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <button class="btn btn-danger"><a href="{{ route('communes') }}">Cancel</a></button>
                            <div class="clearfix"></div>
                        </div>
                    </div>
                </form>
