...
@section('content')
    ...
    <div class="layout-content">
        ...
        <div class="container-fluid flex-grow-1 container-p-y">
            <h4 class="font-weight-bold py-3 mb-0">Thématique</h4>
            <div class="text-muted small mt-0 mb-4 d-block breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('admin/home') }}"><i class="feather icon-home"></i></a></li>
                    <li class="breadcrumb-item">Thématique</li>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card mb-4">
                        <h6 class="card-header"><i class="feather icon-user"></i> Thématique Information</h6>
                        ...
                        <div class="card-body">
                            ...
                            <form id="validation" action="{{ route('thematiques/save') }}" method="POST">
                                {{ csrf_field() }}
                                <div class="form-group row">
                                    <label class="col-form-label col-sm-2 text-sm-right">Code</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="code" name="code" value=""
                                            placeholder="Enter un code" required>
                                        <div class="clearfix"></div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-form-label col-sm-2 text-sm-right">Thématique</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="thematique" name="thematique"
                                            placeholder="Enter une thematique" required>
                                        <div class="clearfix"></div>
                                    </div>
                                </div>
                                ...
                                <tbody>
                                    @foreach ($thematiques as $item)
                                        <tr>
                                            ...
                                            <td class="id">{{ $item->thematique }}</td>
                                            <td class="text-center">
                                                <a href="{{ url('admin/thematique/update/' . $item->id) }}"
                                                    class="m-r-15 text-muted userUpdate">
                                                    <i class="fa fa-edit" style="color: #2196f3;"></i>
                                                </a>
                                                <a href="{{ url('admin/thematique/delete/' . $item->id) }}"
    ...
    <script>
        $('#validation').validate({
            ...
            messages: {
                ...
                thematique: "saisissez une thematique*",
