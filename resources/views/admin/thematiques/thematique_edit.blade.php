...
@section('content')
    ...
    <div class="layout-content">
        ...
        <div class="container-fluid flex-grow-1 container-p-y">
            <h4 class="font-weight-bold py-3 mb-0">thematique / Update</h4>
            <div class="text-muted small mt-0 mb-4 d-block breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('admin/home') }}"><i class="feather icon-home"></i></a></li>
                    <li class="breadcrumb-item">thematique Update</li>
                    <li class="breadcrumb-item active">thematique Update</li>
                </ol>
            </div>

            <div class="card mb-4">
                <h6 class="card-header"><i class="feather icon-user"></i> thematique Update</h6>
                ...
                <div class="card-body">
                    ...
                    <form id="" action="{{ route('thematique/edit') }}" method="POST">
                        ...
                        <div class="form-group row">
                            <label class="col-form-label col-sm-2 text-sm-right">thematique</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <a href="{{ route('thematiques') }}" class="m-r-15  btn btn-danger text-white ">Retour</a>
