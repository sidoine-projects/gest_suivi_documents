...
<div class="layout-content">
    ...
    <div class="container-fluid flex-grow-1 container-p-y">
        <h4 class="font-weight-bold py-3 mb-0">Departement </h4>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card mb-4">
                    <h6 class="card-header"><i class="feather icon-user"></i> Departement Infomation</h6>
                    ...
                    <div class="card-body">
                        ...
                        <form id="validation" action="{{ route('departements/save') }}" method="POST">
                            {{ csrf_field() }}
                            <div class="form-group row">
            ...
            <div class="col-md-6">
                <div class="card mb-4">
                    <h6 class="card-header"><i class="feather icon-user"></i> Liste Departement Infomation</h6>
