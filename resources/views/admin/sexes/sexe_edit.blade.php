...
<div class="layout-content">
    ...
    <div class="container-fluid flex-grow-1 container-p-y">
        <h4 class="font-weight-bold py-3 mb-0">Sexe / Update</h4>
        <div class="text-muted small mt-0 mb-4 d-block breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{route('home')}}"><i class="feather icon-home"></i></a></li>
                <li class="breadcrumb-item">Sexe Update</li>
                <li class="breadcrumb-item active">Sexe Update</li>
            </ol>
        </div>

        <div class="card mb-4">
            <h6 class="card-header"><i class="feather icon-user"></i> Sexe Update</h6>
            ...
            <div class="card-body">
                ...
                <form id="" action="{{ route('sexes/edit') }}" method="POST">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group row">
                        <label class="col-form-label col-sm-2 text-sm-right">Sexe</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <button type="submit"  id="update" name = "update" class="btn btn-primary">Modifer</button>
                            <a href="{{ url('sexe/new') }}" class="m-r-15  btn btn-danger text-white ">Retour</a>
