...
@section('content')
        ...
        <div class="container-fluid flex-grow-1 container-p-y">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card mb-4">
                        <div class="card-body">
                            <div id="graphParAnnee" style="height: 300px"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="card mb-4">
                        <div class="card-body">
                            <div id="graphParAnnee1" style="height: 300px"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div id="graphParSexe" style="height: 600px"> </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div id="graphParSexe1" style="height: 600px"> </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div id="graphParSex" style="height: 600px"> </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="card mb-4">
                        <div class="card-body">
                            <div id="graphParNivInstruc" style="height: 300px"></div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
    ...
    <script>
        ...
        Highcharts.chart('graphParSexe', {
            ...
            series: [
                //$evolu->dimension ==$dim->libelle and
                ...
                @foreach ($listsexe as $sexe)
                    ...
                    @foreach ($listDim as $dim)
                        ...
                        @foreach ($evolutionSexe as $evolu)
                            ...
                            @if ($evolu->sexe == $sexe->libelle and $evolu->annee == '2013' and $evolu->dimension == $dim->libelle)
                            ...
                            @if ($evolu->sexe == $sexe->libelle and $evolu->annee == '2014' and $evolu->dimension == $dim->libelle)
                ...
                @foreach ($listsexe as $sexe)
                    ...
                    @foreach ($listDim as $dim)
                        ...
                        @foreach ($evolutionSexe as $evolu)
                            ...
                            @if ($evolu->sexe == $sexe->libelle and $evolu->annee == $annee1 and $evolu->dimension == $dim->libelle)
                            ...
                            @if ($evolu->sexe == $sexe->libelle and $evolu->annee == $annee2 and $evolu->dimension == $dim->libelle)
        ...
        Highcharts.chart('graphParSexe1', {
            ...
            series: [
                ...
                @foreach ($listsexe as $sexe)
                    ...
                    {
                    name: 'Year {{$i}} {{$annee2 }} {{ $sexe->libelle }} ',
