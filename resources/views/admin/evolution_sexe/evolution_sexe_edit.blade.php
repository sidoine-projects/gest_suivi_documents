...
<div class="layout-content">
    ...
    <div class="container-fluid flex-grow-1 container-p-y">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card mb-4">
                    <h6 class="card-header"><i class="feather icon-user"></i> Evolution sexe Update</h6>
                    ...
                    <div class="card-body">
                        ...
                        <form id="validation" action="{{ route('evolution_sexe/edit') }}" method="POST">
                            {{ csrf_field() }}
                            ...
                            <div class="row">
                                <div class="form-group col-md-3">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <select class="form-control"  name="annee" id="annee" required>
                                            ...
                                            <option @if ($datas->annee_id == $item->id) selected @endif value="{{$item->id}}">{{$item->annee}}</option>
                                            @endforeach
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control"  name="dimension" id="dimension" required>
                                            @foreach ($listDim as $item)
                                                <option @if ($datas->dimenesion_id == $item->id) selected @endif value="{{$item->id}}">{{$item->libelle}}</option>
                                            @endforeach
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control"  name="sexe" id="sexe" required>
                                            @foreach ($listSexe as $item)
                                                <option @if ($datas->sexe_id == $item->id) selected @endif value="{{$item->id}}">{{$item->libelle}}</option>
                                            @endforeach
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="taux" name="taux" value="{{ $datas->taux }}" placeholder="Enter le taux" required>
                                        <div class="clearfix"></div>
                                    </div>
                                    @error('taux')
                            ...
                            <div class="form-group row  m-auto ">
                                ...
                                <div class="col-md-4 text-center">
                                 ...
                                 <a href="{{ url('evolution_sexe/new') }}" class="m-r-15  btn btn-danger text-white ">Retour</a>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                        </form>
...
<script>
    $('#validation').validate({
        ...
        messages:{
            ...
            sexe:"Please saississez un sexe*",
