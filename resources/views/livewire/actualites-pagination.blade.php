    ...
    <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
        <div class="member" data-aos="fade-up" data-aos-delay="100">
            <div class="member-img">
                ...
                <div class="social">
                    <a  href="{{url('single-article/'.$item->id.'/'.$item->titre)}}"><i style="font-size: 30px !important" class="bi bi-eye"></i></a>
            ...
            <div class="member-info">
                ...
                <a style="font-size: 12px" class="text-info" href="{{url('single-article/'.$item->id.'/'.$item->titre)}}">{{ $item->titre }}</a>
